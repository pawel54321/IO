        ...
        return (
            <Card style={{marginBottom: '20px', boxShadow: '0 .5rem 1rem rgba(0,0,0,.15)'}}> 
                ...
                <CardBody className='text-center'>
                    ...
                    {/*<CardText><b>Liczba miejsc:</b> {this.props.atrakcja.liczbaMiejsc}</CardText>*/}
                    <CardText><b>Godz. otwarcia:</b> {this.props.atrakcja.godzOtwarcia}</CardText>
                    <CardText><b>Godz. zamkniecia:</b> {this.props.atrakcja.godzZamkniecia}</CardText>
